  ...
  return (
    <Layout>
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-6xl mx-auto relative">
        ...
        {/* Stage Area */}
        <div className="w-full aspect-video max-h-[600px] bg-white/60 backdrop-blur-md rounded-[3rem] shadow-2xl border-8 border-amber-200/50 flex flex-col items-center justify-center p-10 relative overflow-hidden">

          {/* Decorative Corner Lotuses */}
          <img src="/lotus.svg" className="absolute top-2 left-2 w-16 h-16 opacity-50 rotate-[-15deg] pointer-events-none" alt="" />
          <img src="/lotus.svg" className="absolute top-2 right-2 w-16 h-16 opacity-50 rotate-[15deg] pointer-events-none" alt="" />
          <img src="/cloud.svg" className="absolute bottom-2 left-2 w-24 opacity-40 pointer-events-none" alt="" />
          <img src="/cloud.svg" className="absolute bottom-2 right-2 w-24 opacity-40 pointer-events-none" alt="" />
